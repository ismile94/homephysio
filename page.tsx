...
<body>
    <nav>
        <div class="nav-container">
            <div class="logo">Ismail Aram</div>
    ...
    <section id="home" class="hero">
        <div class="hero-content">
            <h1>Professional <span class="highlight">Home Physiotherapy</span></h1>
            <div class="credentials">
                <span class="credential-badge">HCPC Registered</span>
                <span class="credential-badge">MCSP Chartered</span>
                <span class="credential-badge">BSc (Hons) Physiotherapy</span>
            </div>
        ...
        <div class="hero-image">
            <img src="https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=800&h=600&fit=crop" alt="Professional physiotherapy session">
        </div>
    </section>
    ...
    <section class="stats-section">
        <div class="stats-container">
            ...
            <div class="stat-item">
                ...
                <div class="stat-label">Professional Care</div>
            </div>
        </div>
    </section>
        ...
        <div class="trust-container">
            <div class="trust-card">
                ...
                <div>
                    ...
                    <p style="margin: 0; font-size: 0.9rem; color: #64748b;">Health & Care Professions Council</p>
                </div>
            </div>
            <div class="trust-card">
                ...
                <div>
                    ...
                    <p style="margin: 0; font-size: 0.9rem; color: #64748b;">Member of CSP (MCSP)</p>
                </div>
            </div>
            <div class="trust-card">
                <span class="trust-icon">🏠</span>
                <div>
                    ...
                    <p style="margin: 0; font-size: 0.9rem; color: #64748b;">Fully Insured & DBS Checked</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="services" class="section-wrapper">
        <h2 class="section-title">Specialist Services</h2>
        <p class="section-subtitle">Comprehensive physiotherapy care across a wide range of conditions, delivered with expertise and compassion in your home environment</p>
        <div class="services-grid">
            <div class="service-card" onclick="openModal('neurological')">
                ...
                <p class="click-hint">View conditions & treatments →</p>
            </div>
            <div class="service-card" onclick="openModal('geriatric')">
                <div class="service-icon">👴</div>
            ...
            <div class="service-card" onclick="openModal('postOp')">
                <div class="service-icon">🏥</div>
            ...
            <div class="service-card" onclick="openModal('balance')">
            ...
            <div class="service-card" onclick="openModal('msk')">
                <div class="service-icon">🦴</div>
            ...
            <div class="service-card" onclick="openModal('respiratory')">
                <div class="service-icon">🫁</div>
    ...
    <section class="conditions-section">
        <div style="max-width: 1200px; margin: 0 auto;">
            ...
            <p class="section-subtitle">Expert physiotherapy for a comprehensive range of medical conditions</p>
        </div>
    ...
    <section id="approach" class="approach-section">
        ...
        <p class="section-subtitle">Evidence-based physiotherapy combining clinical expertise with compassionate, patient-centered care</p>
    ...
    <section class="image-section">
        <div class="image-container">
            <h2 class="section-title">Professional Care in Your Home</h2>
            <div class="image-grid">
                <div class="image-grid-item">
                    <img src="https://images.unsplash.com/photo-1551190822-a9333d879b1f?w=600&h=400&fit=crop" alt="Elderly patient care">
                </div>
                <div class="image-grid-item">
                    <img src="https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=600&h=400&fit=crop" alt="Rehabilitation exercises">
                </div>
                <div class="image-grid-item">
                    <img src="https://images.unsplash.com/photo-1584515933487-779824d29309?w=600&h=400&fit=crop" alt="Home physiotherapy session">
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="process" class="process-section">
        <div class="process-container">
            ...
            <p class="section-subtitle">A simple, straightforward process from initial contact to ongoing care</p>
    ...
    <section class="testimonials-section">
        ...
        <p class="section-subtitle">Real feedback from people we've helped on their recovery journey</p>
        <div class="testimonials-grid">
            <div class="testimonial-card">
                <p class="testimonial-text">"After my stroke, Ismail's expertise and patience helped me regain mobility I thought I'd lost forever. His home visits made all the difference to my recovery."</p>
                <div class="testimonial-author">
                    <div class="author-initial">M</div>
                    <div class="author-info">
                        <h5>Margaret T.</h5>
                        <p>Stroke Recovery Patient</p>
                    </div>
                </div>
            </div>
            <div class="testimonial-card">
                <p class="testimonial-text">"Professional, knowledgeable, and genuinely caring. The post-operative programme following my hip replacement was perfectly tailored to my needs."</p>
                <div class="testimonial-author">
            ...
            <div class="testimonial-card">
                <p class="testimonial-text">"My father's quality of life improved dramatically. The balance exercises and falls prevention strategies gave him confidence to live independently again."</p>
                <div class="testimonial-author">
    ...
    <section id="contact" class="contact-section">
        <div class="contact-container">
            ...
            <div class="contact-form">
                ...
                <textarea placeholder="Tell us about your condition and how we can help... *" required></textarea>
                <button type="submit">Send Message</button>
                <p style="margin-top: 1rem; font-size: 0.85rem; color: #64748b; text-align: center;">We typically respond within 24 hours</p>
            </div>
        </div>
    </section>
    ...
    <footer>
        ...
        <p style="margin-top: 0.5rem;">HCPC Registered | Professional Indemnity Insurance | Enhanced DBS</p>
        <p style="margin-top: 1rem;">© <span id="year"></span> Ismail Aram Physiotherapy. All rights reserved.</p>
    </footer>
    ...
    <script>
        ...
        function openModal(serviceKey) {
            ...
            let content = `<p style="color: #64748b; margin-bottom: 1.5rem;">${service.description}</p>`;
            
            content += '<h4 style="color: #1e293b; font-size: 1.2rem; margin: 1.5rem 0 1rem; font-weight: 600;">Conditions Treated:</h4><ul>';
            service.conditions.forEach(condition => {
                content += `<li>${condition}</li>`;
            });
            content += '</ul>';
            
            content += '<h4 style="color: #1e293b; font-size: 1.2rem; margin: 1.5rem 0 1rem; font-weight: 600;">Treatment Approaches:</h4><ul>';
